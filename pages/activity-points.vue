  ...
  <div class="card border scroll-500">
    <div class="card-body">
      ...
      <div class="mt-4 mb-3">
        ...
        <ul>
          <li v-if="$config.public.showFeatures.nftLaunchpad">Launch NFTs via the NFT Launchpad</li>
          <li v-if="$config.public.showFeatures.nftLaunchpad">Buy or sell NFTs</li>
